...
var solar = (function () { //Javascript module pattern
    ...
    //default rotation to be defined inside this module
    var defaultRotation = 20;
    ...
    function createModules(roofPolygon) {
        ...
        //rotation matrix should be used to rotate the points after its calculation
        //all code is inside populate method inside Polygon
        return roofPolygon.populate(moduleWidth, moduleLength, moduleSpacing);
    ...
    var Polygon = (function () { //This is the class definition for Polygon
        ...
        Polygon.prototype.populate = function (moduleWidth, moduleLength, moduleSpacing) {
            ...
            var options = {
                ...
                googleMap: _googleMap,
                width: moduleWidth || 2,
                length: moduleLength || 2,
                spacing: moduleSpacing || 0.2,
                color: '#0000FF'
            };
            ...
            var leftW = this.width / 2 - moduleWidth / 2;
            var rightW = this.width / 2 - moduleWidth / 2;


            //here is the center point
            var center = Polygon.offsetLatLngPointByMeters(this.center, 0, 0);

            options.center = center;

            polys.push(new Polygon(options));


            var counter = 1;


            while (leftW >= moduleWidth + moduleSpacing) {

                center = Polygon.offsetLatLngPointByMeters(this.center, 0, -1 * (moduleWidth + moduleSpacing) * counter);
                center = rotatePath([center], this.rotation, this.center)[0];
                ...
                counter++;
                leftW -= (moduleWidth + moduleSpacing);
            ...
            while (rightW >= moduleSpacing + moduleWidth) {
                center = Polygon.offsetLatLngPointByMeters(this.center, 0, (moduleWidth + moduleSpacing) * counter);
                center = rotatePath([center], this.rotation, this.center)[0];
                ...
                counter++;
                rightW -= (moduleWidth + moduleSpacing);
